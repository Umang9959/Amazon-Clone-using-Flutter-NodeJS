...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new cn.waitwalker.badge_manager.BadgeManagerPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin badge_manager, cn.waitwalker.badge_manager.BadgeManagerPlugin", e);
    }
    try {
